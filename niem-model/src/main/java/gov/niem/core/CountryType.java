...
import gov.niem.codes.genc.CountryAlpha3CodeType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://release.niem.gov/niem/niem-core/5.0/}CountryRepresentation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "CountryType", namespace = "http://release.niem.gov/niem/niem-core/5.0/", propOrder = {
    ...
    extends ObjectType
{
    ...
    @XmlElementRef(name = "CountryRepresentation", namespace = "http://release.niem.gov/niem/niem-core/5.0/", type = JAXBElement.class, required = false)
     ...
     * This is why there is not a <CODE>set</CODE> method for the countryRepresentation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCountryRepresentation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link CountryAlpha3CodeType }{@code >}
     * 
     * 
     */
